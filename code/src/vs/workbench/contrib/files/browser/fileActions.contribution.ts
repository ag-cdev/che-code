...
import { FilesExplorerFocusCondition, ExplorerRootContext, ExplorerFolderContext, ExplorerResourceWritableContext, ExplorerResourceCut, ExplorerResourceMoveableToTrash, ExplorerResourceAvailableEditorIdsContext, FoldersViewVisibleContext, ExplorerFileDownloadEnabledContext } from '../common/files.js';
...
MenuRegistry.appendMenuItem(MenuId.ExplorerContext, ({
	...
	when: ContextKeyExpr.and(
		...
		ExplorerFileDownloadEnabledContext
	)
}));
